            ...
            <Container>
                ...
                <Section>
                    <Info>
                        ...
                        <Description>MindQuest can automatically grade your assessments, saving you the time.</Description>
                    </Info>
                </Section>
            </Container>
            <Container>
                <Section>
                    <Info>
                        ...
                        <Description>With MindQuest it is easy to set a time limit.</Description>
                    </Info>
                </Section>
                <Section>
                    <Info>
                        ...
                        <Description>With MindQuest you can customize your tests easily</Description>
                    </Info>
                </Section>
                <Section>
                    <Info>
                        ...
                        <Description>Being online allows you and your respondents to access, administrate and take your quizzes from anywhere at anytime.</Description>
                    </Info>
                </Section>
            </Container>
        </AllItems>
